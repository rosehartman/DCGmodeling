...
#these are available here: https://cawater.sharepoint.com/:f:/r/sites/dwr-str/DCG/Shared%20Documents/RMA%20data?csf=1&web=1&e=wCQ4UF 


SMSCG = raster("C:/Users/rhartman/OneDrive - California Department of Water Resources/salinity control gates/SMSCG/Data/smscg/smscg_1940-07_hsit-avgmon_rma.tif")
...
ff <- list.files("C:/Users/rhartman/OneDrive - California Department of Water Resources/salinity control gates/SMSCG/Data/smscg/", pattern = "\\.tif$", full=TRUE)
ffn <- list.files("C:/Users/rhartman/OneDrive - California Department of Water Resources/salinity control gates/SMSCG/Data/no+action/", pattern = "\\.tif$", full=TRUE)
ffx = c(ff, ffn)
ff2 = ffx[seq(2,60, 2)]
s <- stack(ff2)
